    ...
    fn into_response(self) -> Response {
        if let ApiError::Internal(detail) = &self {
            ...
            return (
                ...
                Json(json!({"error":"server_error","error_description":"internal server error"})),
            )
                .into_response();
        }
...
impl From<stream_core::CoreError> for ApiError {
    fn from(e: stream_core::CoreError) -> Self {
        match e {
            stream_core::CoreError::Invalid(m) => ApiError::BadRequest(m),
